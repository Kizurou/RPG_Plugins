 ...
 * UAbilityCost
 *
 * Base class for costs that a BaseGameplayAbility has (e.g. ammo or charges)
 * 
 * @TODO Consider renaming to BaseAbilityCost to ensure clarity of being base class
 */
UCLASS()
class ABILITYSYSTEMFRAMEWORK_API UAbilityCost : public UObject
{
	GENERATED_BODY()
