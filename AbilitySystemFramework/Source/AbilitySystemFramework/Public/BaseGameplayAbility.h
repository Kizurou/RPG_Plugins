 ...
 */
UCLASS()
class ABILITYSYSTEMFRAMEWORK_API UBaseGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	// @TODO Consider switching to a typed Getter for ease of use
	...
	virtual void ActivateLocalPlayerAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData*)
	{ K2_ActivateLocalPlayerAbility(); }

	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, DisplayName = "Activate Local Player Ability", Category = "Ability")
	void K2_ActivateLocalPlayerAbility();

	virtual void ActivateServerAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData*)
	{  K2_ActivateServerAbility(); }

	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, DisplayName = "Activate Server Ability", Category = "Ability")
	...
	// NOTE: The activation on grant is handled elsewhere however this is still being left here in case we need it for other reasons
...
protected:
	...
	virtual void GetAbilitySource(FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, float& OutSourceLevel, const IBaseAbilitySourceInterface*& OutAbilitySource, AActor*& OutEffectCauser) const;
